...
export function CharactersPanel() {
  ...
  return <Panel title="Characters & ESI Sync" keel="coolant" className="dash-hero">
    <p className="ph-mission">Connect characters through official EVE SSO and synchronize read-only personal assets, corporation assets, and blueprints. Corporation assets require a Director character and remain isolated from Production totals. Tokens remain in Windows Credential Manager and are never exposed to the frontend.</p>
