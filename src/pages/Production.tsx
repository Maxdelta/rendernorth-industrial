        ...
        <>
          ...
          {viewMode === "tree" ? (
            <div className="inv-table" style={{ marginTop: 10 }}>
              ...
              <TreeNodeRow node={plan.tree} depth={0} />
            </div>
          ) : (
            <div className="inv-table" style={{ marginTop: 10 }}>
              ...
              {plan.leafTotals.map((l) => (
                <div className="inv-row req-row" key={l.typeId}>
  ...
  return (
    <div className="dash">
      ...
      <div className="data-source" style={{ gridColumn: "1 / -1", marginTop: 4 }}>
        Below: the Sprint 007 demo-seeded requirement ledger <span className="demo-badge">DEMO</span>
      </div>
